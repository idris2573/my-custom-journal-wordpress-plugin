	...
	class FPD_Order {
		...
		public function add_order_item_links( $item_id, $item, $order, $plain_text=null ) {
			...
			if( fpd_get_option('fpd_order_email_customization_link') && $item_has_fpd ) {
				...
				echo sprintf( '<br><a href="%s" style="font-size: 0.9em; color: rgba(0,0,0,0.8);">%s</a>', $url, FPD_Settings_Labels::get_translation('woocommerce', 'order:_email_view_customized_product') );
