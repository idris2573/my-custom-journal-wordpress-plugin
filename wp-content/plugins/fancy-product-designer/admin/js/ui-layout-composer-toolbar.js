jQuery(document).ready(function($) {
	...
	*********************************/
	...
	var $excludeToolsSelect = $('[name="toolbar_exclude_tools[]"]'),
		allTBTools = ['fill', 'move', 'reset', 'font-family', 'text-size', 'text-line-height', 'text-bold', 'text-italic', 'text-underline', 'text-align', 'text-stroke', 'curved-text', 'edit-text', 'text-letter-spacing', 'text-transform'];
